@{
    ...
    RootModule = 'DarkPoSh.BuildTools.psm1'
    ...
    GUID = 'c1ac0e0f-a434-4ad2-b8d0-22ef15bdf21b'
    ...
    Description = 'PowerShell Build Tools - Functions for automating PowerShell content management.'
